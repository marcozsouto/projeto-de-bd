...
public class TelaAuxiliarAlmoxarifadoControlador implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(TelaAuxiliarAlmoxarifadoControlador.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
